 ...
 * @CreateDate: 2019-07-02 14:16
 * @Description: java类作用描述
 */
public class ReboundScorllView extends ScrollView {
    private View inner;
    private float y;
    private Rect normal = new Rect();
    ;

    public ReboundScorllView(Context context) {
        super(context);
    }

    public ReboundScorllView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
