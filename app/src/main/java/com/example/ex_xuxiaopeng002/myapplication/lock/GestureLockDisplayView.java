...
public class GestureLockDisplayView extends View {
    ...
    //选中颜色
    private int mDotSelectedColor = Color.parseColor("#FE8839");
    //未选中时颜色
    private int mDotUnSelectedColor = Color.parseColor("#D8D8D8");
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mCircleRadius = (int) (getWidth() * 1.0f / (5 * mDotCount + 1));
        mDotMargin = (int) (1.5 * mCircleRadius);
